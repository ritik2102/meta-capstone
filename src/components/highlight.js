...
export function Highlight(){
    ...
    return(
        <div>
            <div style={{display:"grid",gridTemplateColumns:"7.5fr 2.5fr"}}>
                <h1 style={{marginLeft:"300px",fontSize:"40px"}}>This weeks specials!</h1>
                <button style={{width:"120px",height:"40px",marginLeft:"33px",backgroundColor:"#F4CE14",borderRadius:"5px",fontWeight:"bold"}}>Order Now</button>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",marginTop:"20px",marginBottom:"0px"}}>
        
                <div style={{borderTopLeftRadius:"10px",borderTopRightRadius:"10px",backgroundColor:"#EEEEEE",width:"350px",marginLeft:"300px"}}>
                ...
                <div style={{borderTopLeftRadius:"10px",borderTopRightRadius:"10px",backgroundColor:"#EEEEEE",width:"350px",marginLeft:"100px"}}> 
                ...
                <div style={{borderTopLeftRadius:"10px",borderTopRightRadius:"10px",backgroundColor:"#EEEEEE",width:"350px",marginRight:"300px"}}>
